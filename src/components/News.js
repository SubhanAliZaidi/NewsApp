        ...
        return (
            <>
                {<div className="container-fluid my-3" style={{ maxWidth: '1000px' }}>
                    ...
                    <h6 className='text-center'>- {this.state.totalResults} Results Found</h6>
                    <div className="row">
                ...
                <div className="container-fluid text-center mx-auto my-3">
                    <div className="btn-group">
                        ...
                        <button disabled={this.state.pagenumber === Math.ceil(this.state.totalResults/15)} type="button" className="btn btn-secondary" onClick={nextButton}>Next</button>
                    </div>
                </div>
            </>
        )
